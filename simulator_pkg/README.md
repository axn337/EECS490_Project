...
``rostopic pub -r 20 /gazebo/set_model_state gazebo_msgs/MelState '{model_name: simple_camera, pose: { position: { x: 1, y: 0, z: 0 }, orientation: {x: 0, y: 0, z: 0, w: 0 } }, twist: { linear: { x: 0, y: 0, z: 0 }, angular: { x: 0, y: 0, z: 0}  }, reference_frame: world }'``
